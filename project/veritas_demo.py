...
class MockTrustScorer:
    ...
    def display_certificate(self, certificate: Dict[str, Any]) -> None:
        ...
        print("\n" + "=" * 70)
        print("VERITAS TRUST CERTIFICATE")
        print("=" * 70)
        ...
        print(f"  [Shield] PRIVUS (Privacy): {scores['privacy']}/100")
        print(f"  [Balance] AEQUITAS (Bias): {scores['bias']}/100")
        print(f"  [Light] LUMEN (Transparency): {scores['transparency']}/100")
        print(f"  [Temple] ETHOS (Ethics): {scores['ethics']}/100")
